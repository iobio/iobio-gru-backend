...
if [ ! -f "${out_file}" ]; then
    ...
    '^INFO/AF_nfe,^INFO/AF_amr,^INFO/AF_afr,^INFO/AF_eas,^INFO/AF_sas,^INFO/AF,^INFO/AF_controls_and_biobanks,^INFO/nhomalt_controls_and_biobanks,^INFO/nhomalt,^INFO/AC_controls_and_biobanks_XY,^INFO/AC_XY,^INFO/AC,^INFO/AN,^INFO/AF_popmax,^INFO/VarDP,^INFO/faf95_popmax,^INFO/nonpar' \
    -O z -o ${out_file_tmp} \
    ${in_file}
